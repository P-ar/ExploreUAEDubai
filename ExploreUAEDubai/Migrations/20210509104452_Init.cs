...
namespace ExploreUAEDubai.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VisitorDetailID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitorDetails", x => x.VisitorDetailID);
                });
            ...
            var sqlFile = Path.Combine(".\\scripts", @"Dubaibackups.sql");
